...
PassRefPtr<TransformOperation> SkewTransformOperation::blend(const TransformOperation* from, double progress, bool blendToIdentity)
{
    ...
    if (blendToIdentity)
        return SkewTransformOperation::create(UI::blend(m_angleX, 0.0, progress), UI::blend(m_angleY, 0.0, progress), m_type);
    ...
    return SkewTransformOperation::create(UI::blend(fromAngleX, m_angleX, progress), UI::blend(fromAngleY, m_angleY, progress), m_type);
}
